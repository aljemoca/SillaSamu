...
setup(
    ...
    entry_points={
        'console_scripts': ['esp32Node = samuchair.esp32Node:main',
                            ...
                            'mainNode=samuchair.mainNode:main',
                            'opasistidaNode=samuchair.opasistidaNode:main',
                            'alarmNode=samuchair.alarmNode:main',
                            'BagControlNode=samuchair.BagControlNode:main',
                            'loggerNode=samuchair.loggerNode:main',
        ],
    },
)
