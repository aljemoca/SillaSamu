...
class arduinoNode(Node):
    ...
    def __init__(self):
        ...
        #Agregado para robustecer conexiones
        self.publisher_status = self.create_publisher(String, 'arduino_status',10)
    ...
    def secuencia_conexion(self):
        ...
        msg = String()
        try:
            self.connected = self.arduino.establecePuerto(self.puerto)#Agregado para robustecer conexiones
    ...
    def timer_callback(self):
        if self.modo==1 and self.arduino.esJoystick():    #En modo remoto se manda cada 6 segundos comandos para que no pase a modo local
